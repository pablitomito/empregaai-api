...
exports.generateAIContent = exports.extractATSKeywordsPrompt = exports.generateCoverLetterPrompt = exports.generateOptimizedSummaryPrompt = exports.OPENAI_CONFIG = void 0;
...
const generateOptimizedSummaryPrompt = (userProfile, jobDescription) => {
...
exports.generateOptimizedSummaryPrompt = generateOptimizedSummaryPrompt;
// Prompt para gerar carta de apresentação
const generateCoverLetterPrompt = (userProfile, job) => {
...
exports.generateCoverLetterPrompt = generateCoverLetterPrompt;
// Prompt para extrair palavras-chave ATS
const extractATSKeywordsPrompt = (jobDescription) => {
...
exports.extractATSKeywordsPrompt = extractATSKeywordsPrompt;
// Função auxiliar: Gerar conteúdo com OpenAI
const generateAIContent = async (prompt, maxTokens = exports.OPENAI_CONFIG.MAX_TOKENS) => {
    try {
        const completion = await openai.chat.completions.create({
            ...
            temperature: exports.OPENAI_CONFIG.TEMPERATURE,
        });
